    ...
    return (
      <div className="wall-page container">
        <section className="page-head">
          <h2>Find Your Vibe Today 🎧</h2>
          <p className="subtitle">Match your current mood or shift to a new one through curated songs.</p>
        </section>
          ...
          <div className="mood-grid">
            {moods.map((m, i)=>(
              <label className="mood-tile" key={m.key}>
                <input type="radio" name="mood" className="tile-radio" defaultChecked={i===0} />
        ...
        <section className="settings-card tabset" aria-labelledby="matchshift-title">
          ...
          <div className="tabs" role="tablist">
            <label className="tab-pill">
              <input type="radio" name="mm-mode" className="pill-radio" defaultChecked />
              <span>Match</span>
            </label>
            <label className="tab-pill">
              <input type="radio" name="mm-mode" className="pill-radio" />
              <span>Shift</span>
            </label>
          </div>
  
          <p className="desc">Match: songs from the same mood · Shift: songs that lift or change your mood</p>
          ...
          <button className="btn btn-primary" type="button" aria-disabled="true">💾 Save as Today’s Playlist</button>
        </section>
